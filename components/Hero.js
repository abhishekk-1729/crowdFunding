    ...
    <div className="relative">
        <span className=''>
            ...
            <div className='relative bg-opacity-75 backgroundMain'>
                ...
                <div className="relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 1g:py-20">
                    <div className="flex flex-col items-center justify-between xl:flex-row"> 
                        <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                            ...
                            <p className='max-w-xl mb-4 text-base text-gray-200 md:text-lg'>
                                x x x x x   x x x x x xx x x x x xx  x  x x    xxx  xxx x xxx x xx xxx  xxxx
                            </p>
                            <a 
                                href="/"
                                aria-label=""
                                ...
                                <form>
                                    ...
                                    <div className='mt-4 mb-2 sm:mb-4'>
                                        <button
                                            ...
                                            type="submit"
                                            className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-d bg-deep-purple-accent-400 hover: bg-deep-purple-accent-700 focus: shadow-outline focus: outline-none newColor"
                                        >
                                            Create Campaign
